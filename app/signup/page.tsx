  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50">
      ...
      <form className="flex flex-col space-y-4 w-80">
        <input type="text" placeholder="Name" className="p-3 border text-gray-500 rounded-lg"/>
        <input type="text" placeholder="Class List" className="p-3 border text-gray-500 rounded-lg"/>
